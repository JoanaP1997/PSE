...
\paragraph{Command}
Stellt einen ausführbaren Befehl dar, der die aktuellen Variablenzustände gemäß seiner Semantik verändern kann. Es handelt sich hierbei um eine abstrakte Klasse, von der die, im folgenden UML-Diagramm dargestellten Klassen erben. Diese Art des Entwurfs ermöglicht eine erleichterte Erweiterung um Commands.
%TODO UML Diagramm einfügen
\paragraph{Trace}
...
\paragraph{Term}
Stellt eine Abstrakte Repräsentation eines arithmetischen bzw. logischen Terms dar. Die Klasse und ihre Subklassen sind nach dem Entwurfsmuster Kompositum entworfen, da ein Term wieder aus Termen bestehen kann. Die Subklassen sind im folgenden UML-Diagramm zu sehen.
%TODO UML Diagramm einfügen
