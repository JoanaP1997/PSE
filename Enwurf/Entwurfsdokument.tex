...
\begin{itemize}
\item Klassenbeschreibung: \\
Fehlermeldung, die auftritt, wenn beim Versuch einen Datenblock zu parsen ein Feler entsteht.
\end{itemize}

\paragraph{ParseAssignmentException}
\begin{itemize}
\item Klassenbeschreibung: \\
Fehlermeldung, die auftritt, wenn beim Versuch eine Zuweisung zu parsen kein zulässiger Datentyp existiert oder die Syntax fehlerhaft ist.
\end{itemize}

\paragraph{InvalidLineTypeException}
\begin{itemize}
\item Klassenbeschreibung: \\
Fehlermeldung, die auftritt, wenn der Typ einer Zeile nicht existent ist, also kein DatenBlock, TextBlock oder Zuweisung ist.
\end{itemize}
