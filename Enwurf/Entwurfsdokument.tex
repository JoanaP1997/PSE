...
Für die Implementierung der Benutzeroberfläche wird die Bibliothek \textit{javax.swing} benutzt. Durch die Nutzung von Swing besteht der Grundaufbau des User Interfaces aus einem \enquote{Kompositum}.
...
Außerdem wird die GUIFacade beim Start des Produkts im Rahmen des Beobachtermusters bei MVC (siehe Kapitel 3) bei der \textit{DebugLogic} als Beobachter angemeldet und besitzt eine update()-Methode, über welche die Änderung der anzuzeigenden Daten gesteuert wird.
...
\begin{figure}[!h]
%\makebox[\textwidth][c]{\includegraphics[width=1\textwidth]{diagrammIdeenUmlet/DebuggerOverview.pdf}}
