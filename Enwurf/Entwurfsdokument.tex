...
pdftitle={PSE: Entwicklung eines relationalen Debuggers - Entwurfsdokument},%
,%
}
...
\begin{figure}[!h]
    \makebox[\textwidth][c]{\includegraphics[width=0.8\textwidth]{diagrammIdeenUmlet/debuglogic_DebugLogicController.png}}
...
\begin{figure}[!h]
\makebox[\textwidth][c]{\includegraphics[width=1.0\textwidth]{diagrammIdeenUmlet/Filehandler_Ansicht2.pdf}}
...
\begin{figure}[!h]
\makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{diagrammIdeenUmlet/DebuggerOverview.pdf}}
...
Jeder Interpreter muss einiges an Fehlerüberprüfung durchführen. So müssen hier vor allem semantische Fehler in den vom Nutzer eingegebenen Programmen entdeckt werden. Dazu zählen das Fehlen eines Return-Statements (\textit{MissingReturnCallException}) oder eine im Typsystem nicht erlaubte Zuweisung (\textit{WrongTypeAssignmentException}), wie etwa \texttt{boolean x = 9.3f}. Auch Funktionsaufrufe mit falschen Argumenten (\textit{WrongArgumentExceptions}) oder nicht vorhandener Funktionen (\textit{RoutineNotFoundException}) werden hier abgefangen.
...
\end{center}
%  Nach jetzigem Stand müsste es vielleicht "[...] ein \textit{ConfigurationFile} Obekt vom FileHandler [...]" heißen?
