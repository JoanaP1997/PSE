...
\end{figure}
Über diesen Baum läuft der \textit{CommandGenerationVisitor} und erzeugt für jede Routine einen Baum aus Befehlen(\textit{Command}- Kompositum, siehe Abbildung \ref{Patterns}). Dabei verwendet er zwei weitere Visitor-Objekte, die ihm Bedingungen und Terme in Form der in Abbildung \ref{Terme} gegebenen Klassen erzeugen. 
...
\subsection{Konntextfreie Antlr-Grammatik für WLang-Syntax}
\begin{verbatim}
...
\end{verbatim}
\subsection{Kontextfreie Antlr-Grammatik für Syntax vonbedingten Breakpoints}
\begin{verbatim}
