...
Hierbei handelt es sich um den Entwurf des Produkts \textit{DIbugger}, welches im Pflichtenheft definiert wurde. Aufgabe des \enquote{DIbuggers} ist es, dem Nutzer zu helfen, mehrere Programme gleichzeitig zu debuggen und interaktiv zu analysieren. \\
...
\textit{AntlrParser}.  (Siehe Abbildung \ref{Architekturdiagramm}.)\\
...
\begin{figure}[!h]
\makebox[\textwidth][c]{\includegraphics[width=0.95\textwidth]{diagrammIdeenUmlet/Filehandler_Ansicht1.png}}
