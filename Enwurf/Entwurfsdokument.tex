...
Weiter erzeugt der \textit{FileHandler} Objekte, die Konfigurations-, Sprach- und Einstellungsdateien in abstrakter Form repräsentieren, und kann diese nach außen weitergeben.
\paragraph{Schnittstellen}
\begin{itemize}
