...
\begin{figure}[!h]
\centering
\includegraphics[width =1.4 \textwidth]{diagrammIdeenUmlet/fassaden.pdf}
...
\begin{center}
\makebox[\textwidth][c]{\includegraphics[width=1.44\textwidth]{diagrammIdeenUmlet/TraceGenerationClasses.pdf}}
...
\begin{center}
\makebox[\textwidth][c]{\includegraphics[width=1.0\textwidth]{diagrammIdeenUmlet/ParseTreeExample.pdf}}
