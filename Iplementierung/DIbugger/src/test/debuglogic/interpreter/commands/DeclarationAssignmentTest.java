...
public class DeclarationAssignmentTest {
    ...
    @Test
    public void test_DeclarationAssignment_valid() throws DIbuggerLogicException {
    ...
    public void test_DeclarationAssignment_variableAlreadyDeclared() throws DIbuggerLogicException {
        GenerationController gc = new GenerationController(1000, 1000);
        Scope s = new Scope();
        gc.pushScope(s);
        // create Command
    ...
    public void test_DeclarationAssignment_WrongTypeAssignment() throws DIbuggerLogicException {
        GenerationController gc = new GenerationController(1000, 1000);
        Scope s = new Scope();
        gc.pushScope(s);
        // create Command
