 ...
 * 
 * @author Pascal
 * Contains Properties Data for the DIbugger UI to work.
 */
public class PropertiesFile {
	...
	/**
	 * set the language
	 * @param selectedLanguage new languageID
	 */
	...
	/**
	 * 
	 * @return the filesystem location of the last used configurationFile as String
	 */
	 ...
	 * @param configFile new location of the last configFile
	 */
	...
	/**
	 * 
	 * @param maxWhileIterations new number of while iterations
	 */
	...
	/**
	 * 
	 * @param maxFunctionCalls new maximum amount of recursive function calls
	 */
