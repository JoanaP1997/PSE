...
public class RDBFData {
    ...
    /**
     * 
     * @return the type of the value as an integer supplied by the constants
     *         (DATA_STRING,DATA_INT,...) in this class
     */
    ...
    /**
     * Sets the value of this assignment and generates the dataType from the
     * given value
     * 
     * @param value
     *            new value of the assignment
     */
