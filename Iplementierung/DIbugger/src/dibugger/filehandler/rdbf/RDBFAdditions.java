...
/**
 * abstract class containing a list of RDBFBlock and RDBFData and methods for getting the items inside
 * @author Pascal
 *
 */
public abstract class RDBFAdditions {
	 ...
	 * @return a list containing all RDBFBlock object with the given name (identifier)
	 */
	 ...
	 * @param identifier the identifier of the RDBFData
	 * @return a list containing all RDBFData objects with the given identifier as their name
	 */
