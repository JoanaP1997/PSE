...
public class RDBFParser {
	 ...
	 * @throws ParseBlockException if the line is invalid or contains no block start
	 */
	 ...
	 * @throws ParseAssignmentException if the line is no valid assignment or assigns data of an invalid type
	 */
	 ...
	 * @throws ParseAssignmentException if the line is not an valid assignment
	 */
	...
	/**
	 * Finds the LineType as defined in constants with prefix LINE_ in this class
	 * @param line this line to evaluate
	 * @return the lineType as Defined in this class
	 * @throws InvalidLineTypeExeption if the line is not a valid line defined in the RDBF Format
	 */
...
//		System.out.println(line);
	 ...
	 * @throws ParseAssignmentException if the value is not a String value
	 */
	 ...
	 * @throws ParseAssignmentException if the value is not an Integer value
	 */
	 ...
	 * @throws ParseAssignmentException if the value is not a Long value
	 */
	 ...
	 * @throws ParseAssignmentException if the value is not a Float value
	 */
	 ...
	 * @throws ParseAssignmentException if the value is not a Double value
	 */
	 ...
	 * @throws ParseAssignmentException if the value is not a Boolean value
	 */
