...
public class DebugLogicController {
   ...
   *
   * @param numberOfProgram the number of program to return breakpoints of
   ...
   * @param programId the ID of program to change the stepsize of
   * @param stepSize      the new stepsize to use while debugging
   * @throws SyntaxException in case the syntax of the stepsize string is wrong
   * @see DebugLogicFacade#setStepSize(int, int)
   */
   ...
   * @throws DIbuggerLogicException in case no step can be performed
   ...
   *
   * @throws DIbuggerLogicException in case continue cannot be performed
   ...
   *
   * @param programNameId the id of program to do a step in
   ...
   * @param expressionId id of the WatchExpression
   ...
   * @param expression        the expression of the watch expression
   * @throws DIbuggerLogicException in case the WatchExpression cannot be created
   ...
   *
   * @param expressions WatchExpressions
   * @throws DIbuggerLogicException in case one or more WatchExpressions cannot be created
   */
   ...
   *
   * @param watchExpressionId the id of the watch expression to change
   ...
   * @throws DIbuggerLogicException in case the Cond Breakpoint cannot be created
   ...
   *
   * @param breakPointId the id of the breakpoint to change
   * @param condition    the condition of the breakpoint
   * @param scopes       a list of all scopes
   * @throws DIbuggerLogicException in case the Cond Breakpoint cannot be changed
   ...
   *
   * @param conditionalBreakPointId the id of the breakpoint
...
//    }
   ...
   *
   * @param programNameId the program's number
   * @param line          the line to create a breakpoint at
   ...
   *
   * @param programNameId the number of program to delete a breakpoint of
   * @param line          the line number referring to the breakpoint
   ...
   *
   * @throws DIbuggerLogicException in case the debug mode cannot be started
   ...
   *
   * @param inputVariableId the variable's name
   * @param range           the range containing the value to suggest
   ...
   *
   * @param stepSizeStrategyId the strategy id to select
   ...
   *
   * @param expressionStrategyId the strategy id to select
   ...
   *
   * @param inputValueStrategyId the strategy id to select
