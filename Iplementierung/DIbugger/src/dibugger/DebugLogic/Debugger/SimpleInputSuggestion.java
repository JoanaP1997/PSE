...
/**
 * Generates Input Values based on {@linkplain SplittableRandom} pseudorandom number generator.
 * @author Pascal
 *
 */
public class SimpleInputSuggestion extends InputValueSuggestion{
	...
	/**
	 * Generates a Number with leading zeros based on the size of b.
	 * Examples: 046, 003, 134, ...
	 * @param rand the RandomNumberGenerator to use
	 * @param a begin of the interval to generate
	 * @param b end of the interval to generate
