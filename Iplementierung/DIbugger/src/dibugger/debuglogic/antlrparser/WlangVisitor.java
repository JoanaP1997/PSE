...
public interface WlangVisitor<T> extends ParseTreeVisitor<T> {
    ...
    /**
     * Visit a parse tree produced by the {@code ifElseWithBlock} labeled
     * alternative in {@link WlangParser#ifelseState}.
     * 
     * @param ctx
     *            the parse tree
     * @return the visitor result
    ...
    /**
     * Visit a parse tree produced by the {@code ifElseWithSingle} labeled
     * alternative in {@link WlangParser#ifelseState}.
     * 
     * @param ctx
     *            the parse tree
    ...
    /**
     * Visit a parse tree produced by the {@code FunctionCallInTerm} labeled
     * alternative in {@link WlangParser#term}.
     * 
     * @param ctx
     *            the parse tree
