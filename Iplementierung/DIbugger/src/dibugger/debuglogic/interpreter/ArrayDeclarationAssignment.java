...
public class ArrayDeclarationAssignment extends Command {
    ...
    public ArrayDeclarationAssignment(GenerationController controller, int linenumber, String identifier,
            Term firstsize, Term secondsize, List<List<Term>> value) {
        super(controller, linenumber);
        DIM = 2;
    ...
    public ArrayDeclarationAssignment(GenerationController controller, int linenumber, String identifier,
            Term firstsize, Term secondsize, Term thirdsize, List<List<List<Term>>> values) {
        super(controller, linenumber);
        DIM = 3;
        this.sizeA = firstsize;
        this.sizeB = secondsize;
