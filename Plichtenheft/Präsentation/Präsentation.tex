...
\title[Definitionsphase]{Praxis der Softwareentwicklung\\ Kolloqium Definitionsphase} % The short title appears at the bottom of every slide, the full title is only on the title page
