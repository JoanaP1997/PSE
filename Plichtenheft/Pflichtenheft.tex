...
\begin{itemize}
    \item [/AF10/] \textbf{Name}: Hinzufügen von Quelltext\\ 
        \textbf{Ausnahmen}:\\
	Besitzt der hinzuzufügende Quelltext mehr als 100 Zeilen, so benachrichtigt DIbugger den Benutzer über /A10/.\\
	Besitzt der hinzuzufügende Quelltext mehr als 200 Zeilen, so wird dieser nach /A10/ nicht hinzugefügt, und
	DIbugger benachrichtigt den Benutzer mittels einer Fehlermeldung.\\
        \textbf{Textuelle Beschreibung}:\\
	Der Nutzer möchte einen Programmquelltext zu DIbugger hinzufügen, auf welchen er über die Dateiverwaltung
	seines Betriebssystems zugreifen kann.\\
	Dazu wählt er die Schaltfläche \enquote{Datei} der Menüleiste.\\
	In der Menüansicht wählt er anschließend die Fläche \enquote{Neu}.\\
	...
	Der Quelltext erscheint in einem Eingabefenster von DIbugger.
    ...
    Die Nutzerin möchte einen von ihr durchgeführten Debug-Lauf speichern, um ihn später zu wiederholen, an dieser Stelle fortzusetzen, oder an einen anderen Benutzer weitergeben. Dazu wählt sie zu einem beliebigen Zeitpunkt, nachdem sie mindestens einen zu debuggenden Quellcode hinzugefügt hat, im Dateimenü den Punkt Konfigurationsdatei speichern aus. \\
    Anschließend kann die Benutzerin den Speicherort der \gls{Konfigurationsdatei} über ein Pop-Up Fenster auswählen.\\
...
\newpage
    \subsection{Beschreibung}
        ...
        spezifiziert werden.\\
        Über die Menüleiste können Menueinträge zum Verwalten von Konfigurationsdateien, Anzeigen von Vorschlägen für bedingte Breakpoints, Watch-
        Expressions und Eingabevariablen betätigt werden. Genauso wird Veränderung der Benutzeroberflächensprache über Betätigung der Menueinträge ermöglicht.
