...
\newglossaryentry{Konfigurationsdatei}
{
	...
	Breakpoints, Watch-Expressions, Eingabevariablen, \glspl{Schrittgrösse} und die Stelle, an der das Debuggen eventuell unterbrochen wurde}
}
...
\section{Produktfuntionen}
		...
		\item[/FA140/] Das Produkt bietet die Möglichkeit, eine \gls{Konfigurationsdatei} für einen Lauf zu speichern. Diese beinhaltet festgelegte Eingabewerte, \glspl{Breakpoint}, \glspl{Watch-Expression}, \gls{Schrittgrösse} und die zu debuggenden Programme, sowie die aktuellen Befehle, an denen die Ausführung steht.
		...
		\item[/FA300/] Das Produkt kann, abhängig von der Zeilenanzahl der Programme, dem Benutzer die \gls{Schrittgrösse}(Step-Size) vorschlagen.
 ...
 \newpage		
	...
	\subsection{Nichtfunktionale Anforderungen}
		...
		\begin{itemize}
			...
			Zu diesen gehören die Eingabewerte, \glspl{Schrittgrösse}, Variablenauswahl, Programmcode und Position beider Programme, aber nicht die Ausgabewerte. \\
		...
		Das Produkt ermöglicht das Hinzufügen von Eingabevariablen, Watch-Expressions, \gls{Schrittgrösse} und Breakpoints in Echtzeit. Das Ausführen von Schritten, Step-Over und Step-Out, sowie das Erreichen des nächsten Breakpoints, ist ebenfalls in Echtzeit möglich. \\
...
\begin{itemize}
	...
	\item[/T140/] Verändern der \gls{Schrittgrösse}
...
Der Umfang des Moduls beträgt 8 ECTS, das entspricht 270 Arbeitsstunden pro Teilnehmer. Diese
teilen sich wie folgt auf die Phasen der Softwareentwicklung auf: \\
\begin{itemize}
