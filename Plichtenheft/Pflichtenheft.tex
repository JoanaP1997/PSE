...
\section{Produktfuntionen}
 ...
 \newpage		
	...
	\subsection{Nichtfunktionale Anforderungen}
		...
		Durch automatisches Warnung bei kritischen Eingaben (A10, A20, A40) und Überprüfung der Semantik, ergibt sich eine hohe Fehlertoleranz bezüglich Benutzereingaben.
...
\begin{itemize}
	...
	Hierbei sind folgende Ausnahmen zu beachten: Besitzt der hinzuzufügende Quelltext mehr als 100 Zeilen, so benachrichtigt das Produkt den Benutzer über /A10/.\\
    ...
    Die Nutzerin möchte den von ihr hinzugefügten Quelltext ändern. Befindet sie sich im Debugmodus, muss sie diesen zuvor abbrechen. \\
    Um den Code zu ändern, kann die Nutzerin den Quelltext direkt im Fenster, durch hineinklicken, bearbeiten. Außerdem kann die Nutzerin auch weitere Quelltexte hinzufüge, oder Quelltexte entfernen.
    ...
    Die Nutzerin möchte einen von ihr durchgeführten Debug-Lauf speichern, um ihn später zu wiederholen, an dieser Stelle fortzusetzen, oder an einen anderen Benutzer weitergeben. Dazu wählt sie zu einem beliebigen Zeitpunkt, nachdem sie mindestens einen zu debuggenden Quellcode hinzugefügt hat, im Dateimenü den Punkt Konfigurationsdatei speichern aus. Anschließend kann die Benutzerin den Speicherort der \gls{Konfigurationsdatei} über ein Pop-Up Fenster auswählen.\\
...
\begin{itemize}
	...
	\item[/T070/] Setzen eines \glspl{Breakpoint} synchron in allen Textfenstern
	\item[/T080/] Löschen eines \glspl{Breakpoint} in einem Textfenster
	\item[/T090/] Löschen aller \glspl{Breakpoint} eines Fensters
	\item[/T100/] Starten des \gls{Debugmodus}
	\item[/T110/] Abbrechen des \gls{Debugmodus}
	\item[/T120/] Halten des Debuggers an (bedingten) \glspl{Breakpoint}
	\item[/T130/] Verändern der Schrittlänge
	\item[/T140/] Einen \gls{Schritt} der gewählten Schrittlänge in allen Fenstern machen
	\item[/T150/] Einen \gls{Einzelschritt} in einem einzelnen Fenster machen
	\item[/T160/] Mittels \gls{Step-Over} eine Funktion nicht inspizieren
	\item[/T170/] Mittels \gls{Step-Out} aus einer Funktion zurückkehren
	\item[/T180/] Korrektes Ausgeben der Ausgabewerte
	\item[/T190/] Korrektes Auswerten der \glspl{Watch-Expression}
...
\begin{itemize}
	...
	\item[/T210/] Hinzufügen einer \gls{Watch-Expression}
	\item[/T220/] Löschen einer \gls{Watch-Expression}
	\item[/T230/] Bearbeiten einer \gls{Watch-Expression}
...
Die Syntax der \gls{Watch-Expression} und bedingten Breakpoints ist durch folgende kontextfreie Ableitungsregeln gegeben: \\\\
...
Das heißt, Watch-Expressions werten sich zu einem beliebigen Wert aus, während sich \glspl{bedingter Breakpoint} immer zu einem Wahrheitswert auswerten.
