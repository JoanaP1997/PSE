...
\section{Produktfuntionen}
		...
		\item[/FA80/] Der Benutzer kann \glspl{Breakpoint} an Zeilen im Code setzen.
		\item[/FA90/] Der Benutzer kann relationale Eigenschaften bezüglich Variablen als \glspl{bedingter Breakpoint} festlegen.
		\item[/FA100/] \glspl{bedingter Breakpoint} können an vom Benutzer bestimmte Stellen im Code gebunden werden.
		\item[/FA110/] Der Benutzer kann relationale Eigenschaften bezüglich Variablen als \glspl{Watch-Expression} festlegen.
		\item[/FA120/] \glspl{Watch-Expression} können an vom Benutzer bestimmte Stellen im Code gebunden werden.
		...
		\item[/FA330/] Die, an den Code gebundenen, \glspl{Breakpoint} verschieben sich mit dem Code, wenn dieser im \gls{Editiermodus} geändert wird.
		\end{itemize}		 		
