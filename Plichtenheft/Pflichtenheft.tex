...
\begin{itemize}
	...
	\item[/T150/] Gleichzeitig in allen Textfenstern einen \gls{Schritt} der jeweils gewählten \gls{Schrittgrösse} machen
		...
		\item Reaktion:	In allen Fenstern wird ein Schritt der jeweiligen Größe ausgeführt. Die aktuellen Variablenwerte werden angezeigt und aktuell erfüllte Watch-Expressions farblich hinterlegt.\frage{Was passiert, wenn alle Programme am Ende angekommen sind?} 
		\end{itemize}	
...
\begin{itemize}
	...
	\item[/T250/] Hinzufügen einer Bereichsbindung
		...
		\item Aktion: Der Nutzer wählt über das Optionenfeld der Watch-Expression die Option \enqoute{an Bereich binden} aus. Dann gibt er im erscheinenden Menü die erste und letzte Zeile des Bereichs in jedem der zu debuggenden Programme an, an den die Watch-Expression gebunden wird. 
	...
	\item[/T260/] Löschen einer Bereichsbindung
		...
		\item Aktion: Der Nutzer wählt über das Optionenfeld der Watch-Expression die Option \enqoute{von Bereich lösen} aus.
	...
	\item[/T270/] Anzeigen einer Bereichsbindung
		\begin{itemize}
		\item Erfolgsvorbedingung: Eine Watch-Expression existiert und wurde bereits an einen Bereich gebunden. 
		\item Aktion: Der Nutzer bewegt die Maus über die Watch-Expression oder wählt über das Optionenfeld der Watch-Expression die Option \enqoute{an Bereich binden} aus. 
...
\begin{itemize}
	...
	\item[/T330/] Anzeigen einer Bereichsbindung
		...
		\item Aktion: Der Nutzer bewegt die Maus über den bedingten Breakpoint oder wählt über das Optionenfeld des bedingten Breakpoints die Option \enqoute{an Bereich binden} aus. 
		\item Reaktion:	Das Produkt zeigt die existierende Bereichsbindung an.  
		\end{itemize}	
