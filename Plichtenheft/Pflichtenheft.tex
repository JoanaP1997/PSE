...
\begin{itemize}
	...
	Der Benutzer möchte einen Programmquelltext hinzufügen, auf welchen er über die Dateiverwaltung
	...
	Hierbei ist folgende Ausnahme zu beachten: Besitzt der hinzuzufügende Quelltext mehr als 100 Zeilen, so benachrichtigt das Produkt den Benutzer über /A10/. Der Quelltext wird in jedem Fall hinzugefügt.\\
    
    \item [/AF20/] Ändern von Quelltext:\\
    Der Benutzer möchte den von ihm hinzugefügten Quelltext ändern. Befindet er sich im \gls{Debugmodus}, muss er diesen zuvor abbrechen. \\
    Um den Code zu ändern kann der Benutzer den Quelltext direkt im Fenster durch hineinklicken bearbeiten. Außerdem kann der Benutzer auch weitere Quelltexte hinzufügen oder Quelltexte entfernen.
    
    \item [/AF30/] Setzen von Breakpoints:\\
    Der Benutzer möchte einen \gls{Breakpoint} hinzufügen. Hierbei hat er die Möglichkeit, einen \gls{Breakpoint} durch Doppelklick direkt in Zeilen im Quelltext zu setzen.\\
