...
Getestet wurde die Graphische Benutzeroberfläche unter den folgenden Aspekten:
\begin{itemize}
	\item Gestaltung
	\item Funktionalität
	\item Performance
...
\end{itemize}
Dabei wurden manuelles Testen der einzelnen Funktionalitäten, manuelles Testen der Testszenarien (siehe Pflichtenheft), sowie Monkey Testing verwendet.
