...
Die globalen Testfälle aus dem Pflichtenheft T10 bis T380 wurden, bis auf die Ausnahmen T60,T100 und T360, welche zu keiner umgesetzen funktionalen Anforderung gehören, manuell ausgeführt und getestet. Bei wenigen Testfällen gab es dabei kleine Abänderungen, da die dazugehörenden Funktionen anders implementiert wurden als im Pflichtenheft noch angenommen. \\
Die Änderungen sind: \\
\begin{itemize}
	...
	\item  in T190 wird der Rückgabewert nicht erst nach Ende des Debuglaufs angezeigt sondern sofort nach Begin
	\item in T260 kann der Benutzer eine Bereichsbindung nur löschen indem er als Bereich das gesamte Programm eingibt
	\item in T270 und T330 kann man eine Bereichsbindung nur Anzeigen, indem man auf das Optionenfeld der Watch-Expression klickt und "Bereichsbindung ändern" auswählt
	\item in T370 eine Variable wird durch auswählen und Rechtsklick entfernt, alle Variablen werden wieder angezeigt, wenn der Button "Ausgeblendete Variablen anzeigen" betätigt wird
\end{itemize}
