...
\begin{itemize}
	...
	\item in T370 eine Variable wird durch Auswählen und Rechtsklick entfernt und alle Variablen werden wieder angezeigt, wenn der Button ȩnquote{Ausgeblendete Variablen anzeigen} betätigt wird
\end{itemize}
